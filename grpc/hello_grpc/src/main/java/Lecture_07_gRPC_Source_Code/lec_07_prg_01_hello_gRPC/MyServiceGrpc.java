...
public final class MyServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.MyService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber,
      Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber> getMyFunctionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MyFunction",
      requestType = Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber.class,
      responseType = Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber,
      Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber> getMyFunctionMethod() {
    io.grpc.MethodDescriptor<Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber, Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber> getMyFunctionMethod;
      ...
      synchronized (MyServiceGrpc.class) {
        if ((getMyFunctionMethod = MyServiceGrpc.getMyFunctionMethod) == null) {
          MyServiceGrpc.getMyFunctionMethod = getMyFunctionMethod =
              io.grpc.MethodDescriptor.<Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber, Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MyFunction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void myFunction(Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber request,
        io.grpc.stub.StreamObserver<Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber> responseObserver) {
  ...
  public static final class MyServiceStub
    ...
    /**
     */
    public void myFunction(Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber request,
        io.grpc.stub.StreamObserver<Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber> responseObserver) {
  ...
  public static final class MyServiceBlockingStub
    ...
    /**
     */
    public Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber myFunction(Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber request) {
  ...
  public static final class MyServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber> myFunction(
        Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MY_FUNCTION:
          serviceImpl.myFunction((Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber) request,
              (io.grpc.stub.StreamObserver<Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber,
              Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.MyNumber>(
  ...
  private static abstract class MyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return Lecture_07_gRPC_Source_Code.lec_07_prg_01_hello_gRPC.HelloGrpc.getDescriptor();
    }
