...
public final class ServerStreamingGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<serverstreaming.Serverstreaming.Number,
      serverstreaming.Serverstreaming.Message> getGetServerResponseMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetServerResponse",
      requestType = serverstreaming.Serverstreaming.Number.class,
      responseType = serverstreaming.Serverstreaming.Message.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<serverstreaming.Serverstreaming.Number,
      serverstreaming.Serverstreaming.Message> getGetServerResponseMethod() {
    io.grpc.MethodDescriptor<serverstreaming.Serverstreaming.Number, serverstreaming.Serverstreaming.Message> getGetServerResponseMethod;
      ...
      synchronized (ServerStreamingGrpc.class) {
        if ((getGetServerResponseMethod = ServerStreamingGrpc.getGetServerResponseMethod) == null) {
          ServerStreamingGrpc.getGetServerResponseMethod = getGetServerResponseMethod =
              io.grpc.MethodDescriptor.<serverstreaming.Serverstreaming.Number, serverstreaming.Serverstreaming.Message>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetServerResponse"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  serverstreaming.Serverstreaming.Number.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  serverstreaming.Serverstreaming.Message.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getServerResponse(serverstreaming.Serverstreaming.Number request,
        io.grpc.stub.StreamObserver<serverstreaming.Serverstreaming.Message> responseObserver) {
  ...
  public static final class ServerStreamingStub
     ...
     * </pre>
     */
    public void getServerResponse(serverstreaming.Serverstreaming.Number request,
        io.grpc.stub.StreamObserver<serverstreaming.Serverstreaming.Message> responseObserver) {
  ...
  public static final class ServerStreamingBlockingStub
     ...
     * </pre>
     */
    public java.util.Iterator<serverstreaming.Serverstreaming.Message> getServerResponse(
        serverstreaming.Serverstreaming.Number request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_SERVER_RESPONSE:
          serviceImpl.getServerResponse((serverstreaming.Serverstreaming.Number) request,
              (io.grpc.stub.StreamObserver<serverstreaming.Serverstreaming.Message>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              serverstreaming.Serverstreaming.Number,
              serverstreaming.Serverstreaming.Message>(
  ...
  private static abstract class ServerStreamingBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return serverstreaming.Serverstreaming.getDescriptor();
    }
