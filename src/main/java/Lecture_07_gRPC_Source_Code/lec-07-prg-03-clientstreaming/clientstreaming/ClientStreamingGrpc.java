...
public final class ClientStreamingGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "clientstreaming.ClientStreaming";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<clientstreaming.Clientstreaming.Message,
      clientstreaming.Clientstreaming.Number> getGetServerResponseMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetServerResponse",
      requestType = clientstreaming.Clientstreaming.Message.class,
      responseType = clientstreaming.Clientstreaming.Number.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<clientstreaming.Clientstreaming.Message,
      clientstreaming.Clientstreaming.Number> getGetServerResponseMethod() {
    io.grpc.MethodDescriptor<clientstreaming.Clientstreaming.Message, clientstreaming.Clientstreaming.Number> getGetServerResponseMethod;
      ...
      synchronized (ClientStreamingGrpc.class) {
        if ((getGetServerResponseMethod = ClientStreamingGrpc.getGetServerResponseMethod) == null) {
          ClientStreamingGrpc.getGetServerResponseMethod = getGetServerResponseMethod =
              io.grpc.MethodDescriptor.<clientstreaming.Clientstreaming.Message, clientstreaming.Clientstreaming.Number>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetServerResponse"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  clientstreaming.Clientstreaming.Message.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  clientstreaming.Clientstreaming.Number.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<clientstreaming.Clientstreaming.Message> getServerResponse(
        io.grpc.stub.StreamObserver<clientstreaming.Clientstreaming.Number> responseObserver) {
  ...
  public static final class ClientStreamingStub
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<clientstreaming.Clientstreaming.Message> getServerResponse(
        io.grpc.stub.StreamObserver<clientstreaming.Clientstreaming.Number> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncClientStreamingCall(
            new MethodHandlers<
              clientstreaming.Clientstreaming.Message,
              clientstreaming.Clientstreaming.Number>(
  ...
  private static abstract class ClientStreamingBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return clientstreaming.Clientstreaming.getDescriptor();
    }
